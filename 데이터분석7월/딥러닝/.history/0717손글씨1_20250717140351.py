...
# 첫 Dense층
# • 출력: 64개 뉴런
# • 파라미터 수: 50,240개 (입력 784 * 64 + 편향 64)
# 두 번째 Dense층(출력층)
# • 출력: 10개 뉴런 (숫자 0~9 분류)
# • 파라미터 수: 650개 (64 * 10 + 편향 10)
# Model: "sequential"
# _________________________________________________________________
#  Layer (type)                Output Shape              Param #
# =================================================================
#  dense (Dense)               (None, 64)                50240   #첫번째Dense층(입력층)파라미터 수: 50,240개 (입력 784 * 64 + 편향 64)
#  dense_1 (Dense)             (None, 10)                650    #두번째Dense층(출력층)파라미터 수: 650개 (64 * 10 + 편향 10)
# =================================================================
