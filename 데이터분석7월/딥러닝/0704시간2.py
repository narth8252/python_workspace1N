...
print(s)
# print( s['2025-10-01'])  # 존재하지 않는 날짜이므로 주석 처리 또는 삭제
print( s['2019-10-02'])
print( s['2019-10-03'])
print( s['2019-10-04'])

# 만약 키가 있는지 먼저 확인하고 싶다면, 이렇게 하면 KeyError 방지
date_to_check = '2025-10-01'
if date_to_check in s.index:
    print(s[date_to_check])
else:
    print(f"{date_to_check}는 인덱스에 없습니다.")
    # 2.240893199201458
# 2025-10-01는 인덱스에 없습니다.
