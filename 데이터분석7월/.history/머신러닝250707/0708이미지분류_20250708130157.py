...
# 트리를 랜덤으로 계속만들어내서 측정값달라지므로 
#                               0으로 고정필수,만들트리의 최대개수, 트리최대깊이 지정,  학습속도
model = GradientBoostingRegressor(random_state=0, n_estimators=100, max_depth=5, learning_rate=0.1)
model.fit(X_train, y_train)     # 학습을 하고
y_pred = model.predict(X_test)
...
# 훈련셋: 0.9677547468057306
# 테스트셋: 0.8530409821956507


# === 로지스틱 분류분석 ===
# 훈련셋: 0.9936356404136834
# 테스트셋: 0.9629629629629629
# === KNN이웃 분석 ===
# 훈련셋평가 0.9888623707239459
# 테스트셋평가 0.9888888888888889
# << DecisionTreeClassifier Model 결과 >>
# 훈련셋 점수 (R^2):  0.5799522673031027
# 테스트셋 점수 (R^2):  0.575925925925926
# 특성의 중요도:  [0.    0.    0.    0.         0.         0.08557164           
# === RandomForestClassifier Model ===
# 훈련셋: 0.9387430389817024
# 테스트셋: 0.937037037037037
# 특성의 중요도: [0.00000000e+00 1.55851326e-03 2.24085309e-02 2.73096160e-03