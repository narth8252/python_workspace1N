...
def loadData():
    ...
    target = np.concatenate((daisy["targets"], dandelion["targets"], rose["targets"], \
                         sunflower["targets"], tulip["targets"]))# ← 저장된 경로랑 맞춰줌
...
#머신러닝의 일부알고리즘과 딥러닝은 반드시 정규화 또 스케일링0~1사이값으로 축소시켜야 유리
data = data/255.0
