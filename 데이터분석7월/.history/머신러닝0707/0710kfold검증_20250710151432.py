...
첫 번째 반복에서는 첫 번째 폴드를 검증 세트로 사용하고 나머지 4개 폴드를 훈련 세트로 사용합니다. 두 번째 반복에서는 두 번째 폴드를 검증 세트로, 나머지 4개 폴드를 훈련 세트로 사용하며, 이 과정을 다섯 번째 폴드까지 반복합니다. 최종적으로 5개의 성능 평가 점수를 얻게 되며, 이들의 평균을 모델의 최종 성능으로 간주합니다.
