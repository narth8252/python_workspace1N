...
# 해석: 예측 오차의 표준편차라고 볼 수 있으며, 약 $73,400의 오차 수준을 의미합니다.
# •R² (결정 계수): 0.589
# ㆍ •  ৹ → ★ 가장 중요한 평가지표 중 하나입니다. 모델이 데이터의 분산을 얼마나 잘 설명하는지를 나타냅니다. 1에 가까울수록 완벽한 예측을 의미합니다.
# 해석: 0.589는 이 모델이 주택 가격 변화(분산)의 약 **58.9%**를 설명한다는 뜻입니다. 즉, 나머지 약 41.1%는 이 모델이 사용한 8개 특성 외의 다른 요인에 의해 결정된다고 볼 수 있습니다. model.score()의 결과와 동일합니다.
