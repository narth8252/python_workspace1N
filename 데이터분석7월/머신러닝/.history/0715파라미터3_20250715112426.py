...
print(f"y_train분포: {dict(zip(*np.unique(y_train, return_counts=True)))} ")  # y_change를 y_train으로 수정
print(f"y_test분포 : {dict(zip(*np.unique(y_test, return_counts=True)))} ")   # y_change를 y_test로 수정
