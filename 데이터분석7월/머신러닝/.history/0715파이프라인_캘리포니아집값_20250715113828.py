...
import numpy as np
import optuna
from sklearn.datasets import fetch_california_housing #"회귀문제" 
...
#California Housing 데이터셋에 "회귀" 문제를 Optuna를 사용하여 최적화하고, 자세한 모델 평가와 시각화를 수행합니다. 이를 통해 모델의 성능과 특성을 종합적으로 분석할 수 있습니다.
