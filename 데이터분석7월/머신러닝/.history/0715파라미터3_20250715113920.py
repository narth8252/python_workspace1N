...
import mglearn
import os
from sklearn.datasets import load_iris, load_breast_cancer #"분류문제" Classirication-accracy
from sklearn.model_selection import train_test_split, GridSearchCV
from sklearn.svm import SVC #하이퍼파라미터 개수가많아서 해보자
from sklearn.metrics import classification_report, accuracy_score

# Breast Cancer 데이터셋은 양성/악성을 구분하는 분류(Classification) 문제
# classification_report : 분류중에서도 이진분류 평가 라이브러리
# 분류 문제에서는 Accuracy(정확도), Precision(정밀도), Recall(재현율) 등이 적합합니다 Accuracy(정확도), Precision(정밀도), Recall(재현율)
