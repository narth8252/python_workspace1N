...
#                             모델을 써서 예측한 후의 오차"
# R² = 1: 예측 완벽 (오차 없음)모두 맞췄다
# R² = 0: 예측 없이 평균만 쓴 것과 같음 = 예측의미없음 (기본평균만큼)
# R² < 0: 모델이 평균보다도 못 맞춤 → 나쁜 모델 (예측이 평균보다 못함)

# 모델상황	     R² 	해석
# 모두 맞췄다	  1	 완벽한 예측
# 평균값만큼예측  0	 예측의미없음 (기본평균만큼)
# 완전히 엉망   <0	예측이 평균보다 못함

#alpha값 적절해야함
#머신러닝 알고리즘은 하이퍼파라미터 → 우리가 수작업으로 찾아야한다
#딥러닝은 자동으로 찾는다. → 이미지,흑백사진의 경우 머신러닝이나 딥러닝이나 비슷