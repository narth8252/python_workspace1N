...
12. 평가지표
 ...
 2)분류
  ...
  오차행렬: confusion Matrix 대각선이 정상
실제값 | Positive | Negative | 예측값 ---------------- Positive | TP | FP | Negative | FN | TN |
...
좀 더 자세한 예시는 다음과 같습니다.

실제값 | 1 (Positive) | 0 (Negative) | 예측값 ------------------ 1 | 50 (TP) | 10 (FP) | 0 | 5 (FN) | 100 (TN) |
