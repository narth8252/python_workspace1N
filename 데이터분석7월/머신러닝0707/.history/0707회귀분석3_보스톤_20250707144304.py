...
R² (결정계수, Coefficient of Determination)는 회귀 모델이 얼마나 잘 예측했는지 측정하는 대표적인 지표야.
...
SST (Total Sum of Squares): 실제 값이 평균으로부터 얼마나 떨어져 있는가 (분산)

SSR (Residual Sum of Squares): 예측값과 실제값 사이의 차이 (오차)
