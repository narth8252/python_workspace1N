/*
250625 pm4:20 프라미스=비동기구나! 사용많아서 중요함.
...
sigma(1000).then(console.log); // 또는 async 함수 안에서 await sigma(100)
/*
설명
...
/*
    ...
    아래예제에서 mainModule(){}함수 안에 넣어야지만 출력됨.
    이런 불편함은 자바스크립트에서 만들어놔서 이렇게 해야함.

    DB데이터에서도 async,await 필수
    모듈을 외부통신할때 비동기통신할때도 필수임. 엄청많이 사용.
