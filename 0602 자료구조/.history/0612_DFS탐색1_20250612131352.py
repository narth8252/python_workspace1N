...
"""
지도의 좌표를 인덱스로 표현한것과 비슷합니다. 아래를 보면 마치 1이 벽이고 0이 길이라고 생각하면 됩니다. 각각의 인덱스들은 상하좌우가 연결되어 있어 빈칸은 이동 가능하고 1은 이동할 수 없습니다. 그럼 0, 0 위치에서 가장 마지막 위치인 5, 5 위치로 이동하는 DFS 탐색을 만들어 보겠습니다.
