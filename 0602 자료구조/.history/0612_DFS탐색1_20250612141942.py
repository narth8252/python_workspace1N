...
"""
DFS함수만들기: 인접행렬의 DFS탐색:재귀호출로 계속 비교하며 사방팔방 확인하는 것
True/False로 쫓아가는 것 싫으면 0 1로 바꿔도 됨
      0   1   2   3   4
     ------------------
...
def dfs(y, x):
    ...
    #위2줄을 아래1줄로 쓰는 방법
        ...
        if not visited[ny][nx]: #아직 미방문이면
            dfs(ny,nx) #새로운 출발점으로해서 재귀호출, 시스템內스택
